...
module.exports = (req, res) => {
    ...
    if (grant_type === 'authorization_code') {
        // unpack code to get userID
        const { userId } = decodeAuthCode(code)
        // generate access_token and refresh_token
        const { access_token, refresh_token, expires_in } = generateTokens({ client_id, userId })
        ...
        const access_token = generateToken({ client_id, userId })
